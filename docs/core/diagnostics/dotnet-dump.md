...
The first step is to collect a dump. This step can be skipped if a core dump has already been generated. .NET Core runtime's built-in [dump generation feature](dumps.md#collecting-dumps-on-crash) can each create core dumps.
